      ...
      {mainScreen === 'home' && (
        <>
          ...
          <main className="w-full max-w-xl flex flex-col items-center relative z-10">
            ...
            <div className="flex flex-col md:flex-row gap-6 w-full justify-center mb-24">
              <button 
                onClick={() => setMainScreen('rimborso')} 
                className="group relative px-8 py-3 rounded-lg bg-transparent backdrop-blur-md border border-white/10 hover:border-cyan-400/50 text-white overflow-hidden transition-all duration-500 shadow-sm hover:shadow-cyan-900/20"
              >
                ...
                <span className="absolute -inset-px bg-gradient-to-r from-cyan-500/10 to-blue-500/10 blur-sm opacity-0 group-hover:opacity-50 transition-opacity duration-700"></span>
                <span className="relative z-10 font-medium text-base group-hover:text-cyan-300 transition-colors duration-500 flex items-center gap-2">
              ...
              <button 
                ...
                className="group relative px-8 py-3 rounded-lg bg-transparent text-white backdrop-blur-md border border-white/10 hover:border-fuchsia-400/50 overflow-hidden transition-all duration-500 shadow-sm hover:shadow-fuchsia-900/20"
              >
                ...
                <span className="absolute -inset-px bg-gradient-to-r from-fuchsia-500/10 to-pink-500/10 blur-sm opacity-0 group-hover:opacity-50 transition-opacity duration-700"></span>
                <span className="relative z-10 font-medium text-base group-hover:text-fuchsia-300 transition-colors duration-500 flex items-center gap-2">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
